/**
 * JChat 3.0 — Super Admin layout (Task 2.17)
 *
 ...
 *
 * TODO(roles): gate this entire layout to Super Admin / Communications Admin
 *   once the roles system exists (post Task 2.17).
 */
...
function NavLink({
  ...
  return (
    <Link
      ...
      // keeping this layout as a server component — styling can be enhanced in Task 3.13.
    >
