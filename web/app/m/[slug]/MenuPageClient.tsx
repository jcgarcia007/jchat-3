...
export default function MenuPageClient({
  ...
  return (
    ...
    >
      ...
      {!["icon-rail", "sticky-tabs", "category-sidebar", "store-sections", "glass-chips", "infinite-feed", "magazine", "streaming-rows", "masonry-search", "fullscreen-type", "timeline", "luxury"].includes(business.menu_template_id) && (
