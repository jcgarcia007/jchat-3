...
export default function MenuPageClient({
  ...
  return (
    ...
    >
      ...
      {!["icon-rail", "sticky-tabs", "category-sidebar", "store-sections", "glass-chips", "infinite-feed", "magazine", "streaming-rows", "masonry-search", "fullscreen-type"].includes(business.menu_template_id) && (
