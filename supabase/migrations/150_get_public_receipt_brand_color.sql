-- 150_get_public_receipt_brand_color.sql
-- Actualiza get_public_receipt para incluir receipt_brand_color del negocio.
-- Copia exacta de 148 con receipt_brand_color añadido al SELECT de businesses
-- y al jsonb 'business'. Aplicada a producción por Planning vía MCP el 2026-08-23.
...
begin
  ...
  select name, logo_url, address, city, state, phone, slug, receipt_brand_color
    into v_biz
